...
<head>
	...
	ul{
		...
		padding-left: 1px;
			...
			List<PBoardVO> PBoardList = pBoardDao.getBoards(startRow, pageSize, "summer");
			//board테이블 전체글 개수 가져오기 메소드 호출
			int count = pBoardDao.getBoardCount("summer");
...
<body>
	<div id="wrap">
		...
		<jsp:include page="../include/header.jsp" />
  		...
  		<h1 id="community"><div>Styling - Summer</div></h1>
